...
public class Pinecone extends Entity{
	...
	public Pinecone(int x, int y, int width, int height, boolean solid, Id id, Handler handler) {
	...
	public void draw(Graphics g) {
		g.drawImage(GamePanel.pinecone.getBufferedImage(), x, y, width, height, null);	
